...
def ayudaAfin():
	...
	print ("| http://seguridad.unicauca.edu.co/criptografia/quijote.txt            	               |")
	print ("|										       |")
	print ("|\tcifrar: python3 principal.py -sa -c quijote.txt 17 4                           |")
	print ("|\tdescifrar: python3 principal.py -sa -d quijote.txt.cif 17 4                    |")
	print ("|\tcifrar codificando: python3 principal.py -sa -c quijote.txt 17 4 -c64          |")
	print ("|\tdescifrar decodificando: python3 principal.py -sa -d quijote.txt.cif 17 4 -c64 |")
	print ("|         									       |")
	print (" --------------------------------------------------------------------------------------")
